...
?>
	...
	<div class="desktop">
        ...
        <div class="container p-2 container-fluid border mb-3">
            <div class="container overflow-auto" >
                <div class="row border mt-2">
                    <div class="col text-center">
                        <a href="superadmin-admin-accounts.php" id="tab1" class="btn my-4 border border-danger text-danger fw-bold fs-3">Admin</a>
                    </div>
                    <div class="col text-center">
                        <a href="superadmin-adviser-accounts.php" id="tab2" class="btn btn-danger my-4 text-white fw-bold fs-3">Advisers</a>
                    </div>
                ...
                <div class="mt-2" id="adviser-table">
            ...
            <?php
                $check_adviser = mysqli_query($connection,"SELECT * FROM tbluser WHERE usertype='Adviser' and status='1'");
            ?>
                            ...
                            <div class="input-group" id="show_hide_password">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text" style="border-top-left-radius: 0rem; border-bottom-left-radius: 0rem;" onclick="password_show_adviser_add();">
                                        ...
                                        <i class="fas fa-eye-slash d_edit_adviser" id="hide_eye_edit_adviser" style="display: none;"></i>
                                    </span>
                                </div>
                            </div>
                        </div>
