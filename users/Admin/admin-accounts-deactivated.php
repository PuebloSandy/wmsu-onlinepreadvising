...
<head>
    ...
    <title>Accounts Deactivated</title>
</head>
        ...
        <div class="container overflow-auto" >
            <div class="row mt-2">
                <div class="col mb-2" align="left">
                    <button type="button" class="btn rounded btn-secondary text-light p-2 fas fa-chevron-left" title="Deactivated" onclick="location.href='admin-accounts.php'"> Back</button>     
                </div>
                <div class="row mt-2">
                    <div class="col ml-4">
                <?php
                    $check_adviser = mysqli_query($connection,"SELECT * FROM tbluser WHERE usertype='Adviser' and college_id_fk='$collegeid' and status='0'");
                ?>
     ...
     <div class="modal fade" id="editAdviserModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            ...
            <form action="managedata.php" method="POST">
                    ...
                    <div class="form-group">
                        <label>Status</label>
                        <select name="status" class="form-control text-center" id="adviser-status">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="editAdviserDeactivated" class="btn btn-primary">Save</button>
                </div>
            </form>
            </div>
        </div>
