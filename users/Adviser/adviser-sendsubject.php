            ...
            <?php
                ...
                if(mysqli_num_rows($select_subject_sem) > 0)
                {
                    foreach($select_subject_sem as $se)
                    {
						...
						$check_get_subid = mysqli_query($connection,"SELECT * FROM tbladviser_presubject WHERE remarks='PASSED' and adviser_id_fk='$adviserid' and student_id='$Studid' and subject_id_fk='$subjectID' and curri_id='$Currid' and course_id_fk='$courseid'");
