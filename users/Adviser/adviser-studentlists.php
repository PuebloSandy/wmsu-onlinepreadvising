...
?>
		...
		<!-- CONTENT -->
		<div class="container" >
			<p class="text  mt-3 text-danger fw-bold text-center fs-2" style="cursor: default;"><?php echo $code ?> Student Info and Subjects Lists</p>
		</div>
		...
		<div class="container p-2 container-fluid mb-3" >
			<div class="container overflow-auto" >
				<div class="mb-3" align="right">
                    <button type="button" class="btn rounded btn-success p-2 fas fa-clipboard" title="Add" id="addAdviser"> Add Account</button>
                    <button type="button" class="btn rounded btn-danger p-2 fas fa-trash-alt" title="Delete All" id="deleteAllStudent"> Deactivate All Accounts</button>
                </div>
		<?php
			$check_student = mysqli_query($connection,"SELECT * FROM tblstudent_list WHERE status='Enrolled' and course_id_fk='$courseid' and adviser_id_fk='$adviserid'");
		?>
						...
						<tr>
							...
							<td ><center>
								<form action="managedata.php" method="POST">
									...
									<button type="submit" name="check" class="btn btn-success text-light"><?php echo $curr_code ?></button>
								</form>
							</center></td>
                            ...
                            <td><center>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="cursor: pointer;">
                                        <a class="dropdown-item editStudentbtn" title="Edit">Update Student Info</a>
                                        <a class="dropdown-item deleteStudentbtn" title="Delete" >Deactivate Student Account</a>
                                    </div>
								<!--
								<button style="font-size: 1.3rem;" title="Edit" class="fas fa-edit btn rounded btn-success editStudentbtn"></button>
                    ...
                    <form action="managedata.php" method="POST">
                        <!-- Inputs -->
							...
							<div class="form-group">
								...
								<select name="college_status" class="form-control text-center">
							...
							<div class="form-group">
								...
								<select name="year" class="form-control text-center" id="exampleFormControlSelect1">
							...
							<div class="mb-3">
								<label for="input-id" class="form-label">Section</label>
								<input type="text" name="section" class="form-control text-center" id="input-id" autocomplete="off" required>
							</div>-->
                        </div>
    ...
    <div class="container container-fluid">
        <div class="modal fade" id="deleteAllStudentModal" tabindex="-1" aria-labelledby="deletemodalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Deactivate All Student Accounts</h5></h5>
                    <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                </div>
                    <form action="managedata.php" method="POST">
                        <center>
							...
							<input type="hidden" name="adviserid" value="<?php echo $adviserid ?>">
                            <div class="modal-body">
                                All Account will be deactivate!! 
                                Are you sure you want to deactivate All Student Account on your list?
                            </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content ">
				...
				<form action="managedata.php" method="POST">
					...
					<div class="form-group">
						<label for="college-status">Student Status</label>
					...
					<div class="mb-3">
						...
						<input type="text" name="contact" class="form-control text-center" onkeypress="return isNumber(event)" onpaste="return false;" id="student-contact" autocomplete="off" required>
					</div>
                </div>

                <div class="modal-footer" align="right">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="submit" name="editStudent" class="btn btn-success">Update</button>
                </div>
                </form>    
            </div>
        </div>
    ...
    <div class="container container-fluid">
        <div class="modal fade" id="deleteStudentModal" tabindex="-1" aria-labelledby="deletemodalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Deactivate This Account</h5></h5>
                  <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                </div>
                    <form action="managedata.php" method="POST">
                        <center>
                            ...
                            <div class="modal-body">
                                This Account will be deactivate!! 
                                Are you sure you want to deactivate this Account of student?
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                                <button type="submit" name="deleteStudent" class="btn btn-success">Yes</button>
                            </div>                     
                        </center>
                    </form>
                </div>
