                    ...
                    <div class="mb-4" id="fourthYear">
						...
						<div class="mt-2">
                            ...
                            <?php
                                ...
                                else if(mysqli_num_rows($get_total_grades_4th_2nd) == 0)
                                {
                                    ...
                                    if($units_row_4th_2nd != 0 && $fetch_total_4th_2nd != 0)
                                    {
                                        $total_grade_units_4th_2nd = round($fetch_total_4th_2nd / $units_row_4th_2nd, 4);
                                    }
                                    else
                                    {
                        ...
                        <div class="mt-2">
                            ...
                            <?php
                                        ...
                                        $select_at_advised_sub_4th_summer = mysqli_query($connection,"SELECT * FROM tblstudent_subject WHERE id='$SubID_3rd_summer' and student_id_fk='$Studid' and curr_id_fk='$Currid' and yearlevel='4' and semester='summer' and course_id_fk='$curr_courseid'");
                            ...
                            ?>
								...
								<tfoot >	
                                    ...
                                    <tr>
                                        ...
                                        <td hidden></td>
                                        <td hidden></td>
                                        <td class="fw-bold"><center><?php echo $total_grade_units_4th_summer?></center></td>
                                        <td></td>
                                    </tr>
								</tfoot>
							</table>
