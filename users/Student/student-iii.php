...
<html lang="en">
	...
	<body>
		...
		<div class="container container-fluid" id="container-progress">
            ...
            <!-- DESCRIPTION -->
            <span class="title first text float-start" id="active-title" style="cursor: default;">Submit Grades</span> 
            <span class="title second " id="active-title" style="cursor: default;">Select Subjects</span>         
            <span class="title third text float-end" id="active-title" style="cursor: default;">Approval</span>       
        ...
        <center>
            <div class="contaier container-fluid mt-5">
                <p class="fw-bold bg-light w-75 mt-3" id="feedback" style="cursor: default;">Your Grades Has been Approved. Check your List of subjects could take in this Semester. Click the <span><a href="#">Subjects</a> </span>  button below.</p>
            </div>
        </center>
        <!-- FEEDBACK END -->
        ...
        <div class="container text-center mb-4">
            ...
            <a class="btn btn-danger text-white me-1 " href="student-view-subjects.php">Subjects</a>       
        </div>
		<!-- BUTTONS END -->
